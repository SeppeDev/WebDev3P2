                ...
                <ul class="collapsible" data-collapsible="accordion">
                    <li>
                        <div class="collapsible-header active">
                            <h3>Product <i class="fa fa-angle-down" aria-hidden="true"></i></h3>
                        </div>
                    ...
                    <li>
                        <div class="collapsible-header">
                            <h3>Image <i class="fa fa-angle-down" aria-hidden="true"></i></h3>
                        </div>
                        ...
                        <div class="collapsible-body">
                            ...
                            <div class="row">
                                @foreach ($product->pictures as $key=>$picture)
                                    <div class="col l11"><img src="{{ url( $picture->url ) }}"></div>
                    ...
                    <li>
                        <div class="collapsible-header">
                            <h3>Size <i class="fa fa-angle-down" aria-hidden="true"></i></h3>
                        </div>
                        ...
                        <form action="{{ url( '/admin/dashboard/newsize' ) . '/' . $product->id }}" method="POST">
                            ...
                            <div class="row">
                                @foreach ($product->sizes as $key=>$size)
                                    <div class="col l11 title_6">{{$size->name}}: cm {{$size->width}} x {{$size->length}} x {{$size->height}}</div>
                    ...
                    <li>
                        <div class="collapsible-header">
                            <h3>Collections <i class="fa fa-angle-down" aria-hidden="true"></i></h3>
                        </div>
                    ...
                    <li>
                        <div class="collapsible-header">
                            <h3>FAQs <i class="fa fa-angle-down" aria-hidden="true"></i></h3>
                        </div>
